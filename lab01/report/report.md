...
![Создание виртуальной машины 1](pictures/1.png){#fig:001 width=70%}

![Создание виртуальной машины 2](pictures/2.png){#fig:002 width=70%}

![Создание виртуальной машины 3](pictures/3.png){#fig:003 width=70%}

3. Установила центос (рис.4 @fig:004)
   
![Установка образа](pictures/4.png){#fig:004 width=70%}

Установка центос (рис.5 @fig:005)
   
![Установка образа](pictures/5.png){#fig:005 width=70%}

4. Настройка образа.
- Выбор языка (рис.6 @fig:006)
   
![Выбор языка](pictures/6.png){#fig:006 width=70%}

- Обзор установки (рис.7 @fig:007)
   
![Меню установки](pictures/7.png){#fig:007 width=70%}

- Выбор даты и времени (рис.8 @fig:008)
   
![Выбор даты и времени](pictures/8.png){#fig:008 width=70%}

- Выбор приоритетной раскладки (рис.9 @fig:009)
   
![Выбор раскладки](pictures/9.png){#fig:009 width=70%}

- Выбор предварительной установки программ (рис.10 @fig:010)
   
![Выбор программ](pictures/10.png){#fig:010 width=70%}

- Выбор kdump (рис.11 @fig:011)
   
![Выбор kdump](pictures/11.png){#fig:011 width=70%}

- Сеть и имя узла (рис.12 @fig:012)
   
![Сеть и имя узла](pictures/12.png){#fig:012 width=70%}

5. Установка образа действий дополнительной гостевой ОС (рис.13 @fig:013)
   
![Установка образа](pictures/13.png){#fig:013 width=70%}

6. Осуществила поиск в терминале информацию по пк (рис.14 @fig:014)
   (рис.15 @fig:015)
   
![Поиск версии ядра](pictures/14.png){#fig:014 width=70%}(рис.5 @fig:005)
   
![Поиск остальной информации](pictures/15.png){#fig:015 width=70%}
